//
//  DetailClubViewModelTests.swift
//  PMS-iOS-V2Tests
//
...
class DetailClubViewModelTests: XCTestCase {
    ...
    func test_viewDidLoad_activityIndicator() {
        ...
        scheduler.createHotObservable([.next(100, "MoDeep")])
    ...
    func test_viewDidLoad_get_DetailClub() {
        // MARK: - WHEN
        ...
        let observer = scheduler.createObserver(DetailClub.self)
        ...
        let exceptEvents: [Recorded<Event<DetailClub>>] = [
            .next(0, DetailClub(title: "", description: "", imageUrl: "", member: [String]())),
            .next(100, Bundle.getDetialClubJson())
        ]
