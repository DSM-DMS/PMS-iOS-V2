...
class NoticeDetaiilViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        viewModel = NoticeDetailViewModel(id: 2, title: "", noticeRepository: repository)
    ...
    func test_viewDidLoad_noInternet_alert() {
        // MARK: - WHEN
        viewModel = NoticeDetailViewModel(id: 2, title: "", noticeRepository: MockNoticeRepository(test: .noInternet))
