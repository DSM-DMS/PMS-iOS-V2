...
internal enum Asset {
  ...
  internal static let calendarFill = ImageAsset(name: "Calendar.fill")
  internal static let calendar = ImageAsset(name: "Calendar")
  internal static let introduceFill = ImageAsset(name: "Introduce.fill")
  internal static let introduce = ImageAsset(name: "Introduce")
  internal static let mealFill = ImageAsset(name: "Meal.fill")
  internal static let meal = ImageAsset(name: "Meal")
  internal static let mypageFill = ImageAsset(name: "Mypage.fill")
  internal static let mypage = ImageAsset(name: "Mypage")
  internal static let noticeFill = ImageAsset(name: "Notice.fill")
